...
public class RandomNumberProviderService extends ComplicationProviderService {
    ...
    public void onComplicationUpdate(
       ...
       // int randomNumber = (int) Math.floor(Math.random() * 10);
        ...
        String glucoseString="0";
        glucoseString= Singleton.getInstance().getGlucose();

        switch (dataType) {
            case ComplicationData.TYPE_RANGED_VALUE:

                Log.w(TAG, "Ranged Value");
            ...
            case ComplicationData.TYPE_LONG_TEXT:
                ...
                complicationData = new ComplicationData.Builder(ComplicationData.TYPE_LONG_TEXT)
                        .setLongText(
                                ComplicationText.plainText(glucoseString))
                        .setTapAction(pendingIntent)
                        .build();
                break;
            default:
